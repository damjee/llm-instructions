...
description: Test-driven development and test refactoring with red-green-refactor loop. Use when the user wants to build features or fix bugs with TDD, mentions "red-green-refactor" or test-first development, or wants to write or refactor unit or integration tests.
---
